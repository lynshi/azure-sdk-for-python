...
def build_get_ledger_identity_request(ledger_id: str, *, api_version: str = "2022-05-13", **kwargs: Any) -> HttpRequest:
...
class ConfidentialLedgerCertificateClientOperationsMixin(MixinABC):
    @distributed_trace
    def get_ledger_identity(self, ledger_id: str, *, api_version: str = "2022-05-13", **kwargs: Any) -> JSON:
        """get_ledger_identity.
