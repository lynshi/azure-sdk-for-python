...
def build_get_constitution_request(*, api_version: str = "2022-05-13", **kwargs: Any) -> HttpRequest:
...
def build_list_consortium_members_request(*, api_version: str = "2022-05-13", **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_enclave_quotes_request(*, api_version: str = "2022-05-13", **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_collections_request(*, api_version: str = "2022-05-13", **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_ledger_entries_request(
    *,
    api_version: str,
...
def build_create_ledger_entry_request(
    *, api_version: str = "2022-05-13", json: JSON, collection_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    return HttpRequest(method="POST", url=_url, params=_params, json=json, **kwargs)


def build_get_ledger_entry_request(
    transaction_id: str, *, api_version: str = "2022-05-13", collection_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_receipt_request(transaction_id: str, *, api_version: str = "2022-05-13", **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_transaction_status_request(transaction_id: str, *, api_version: str = "2022-05-13", **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_current_ledger_entry_request(
    *, api_version: str = "2022-05-13", collection_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_user_request(user_id: str, *, api_version: str = "2022-05-13", **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_user_request(user_id: str, *, api_version: str = "2022-05-13", **kwargs: Any) -> HttpRequest:
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_or_update_user_request(user_id: str, *, api_version: str = "2022-05-13", json: JSON, **kwargs: Any) -> HttpRequest:
...
class ConfidentialLedgerClientOperationsMixin(MixinABC):
    @distributed_trace
    def get_constitution(self, *, api_version: str = "2022-05-13", **kwargs: Any) -> JSON:
    ...
    @distributed_trace
    def list_consortium_members(self, *, api_version: str = "2022-05-13", **kwargs: Any) -> Iterable[JSON]:
    ...
    @distributed_trace
    def get_enclave_quotes(self, *, api_version: str = "2022-05-13", **kwargs: Any) -> JSON:
    ...
    @distributed_trace
    def list_collections(self, *, api_version: str = "2022-05-13", **kwargs: Any) -> Iterable[JSON]:
    ...
    @distributed_trace
    def get_receipt(self, transaction_id: str, *, api_version: str = "2022-05-13", **kwargs: Any) -> JSON:
        """get_receipt.
    ...
    @distributed_trace
    def get_transaction_status(self, transaction_id: str, *, api_version: str = "2022-05-13", **kwargs: Any) -> JSON:
    ...
    @distributed_trace
    def get_current_ledger_entry(self, *, api_version: str = "2022-05-13", collection_id: Optional[str] = None, **kwargs: Any) -> JSON:
    ...
    @distributed_trace
    def get_user(self, user_id: str, *, api_version: str = "2022-05-13", **kwargs: Any) -> JSON:
        """get_user.
    ...
    @distributed_trace
    def create_or_update_user(self, user_id: str, user_details: JSON, *, api_version: str = "2022-05-13", **kwargs: Any) -> JSON:
